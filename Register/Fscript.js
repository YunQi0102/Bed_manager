...
document.querySelector(".register_datetime").innerHTML = Today.getFullYear() + "/" + (Today.getMonth()+1) +  "/" + Today.getDate() + " " + Today.toLocaleTimeString([], { hour12: false, hour: "2-digit", minute: "2-digit"});
